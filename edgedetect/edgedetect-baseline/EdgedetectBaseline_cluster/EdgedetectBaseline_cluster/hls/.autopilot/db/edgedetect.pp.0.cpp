...
# 42 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 261 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/bits/cpp_type_traits.h" 3
...
# 43 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 44 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
# 100 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/bits/std_abs.h" 3
  inline constexpr
  __float128
  abs(__float128 __x)
...
# 48 "/tools/Xilinx/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cmath" 2 3
...
void rgbToGrayscale(unsigned char input_image[480 * 640 * 3], unsigned char output_image[480 * 640])
{
    VITIS_LOOP_10_1: for (int i = 0; i < 480; i++)
    {
        ...
        VITIS_LOOP_13_2: for (int j = 0; j < 640; j++)
        {
            ...
            unsigned char b = input_image[i * 640 * 3 + jj + 2];
            jj += 3;

            float gray = 0.299 * r + 0.587 * g + 0.114 * b;
            output_image[i * 640 + j] = (unsigned char)floor(gray);
        }
    }
}

void convolve2d_smoothing(unsigned char input_image[480 * 640], unsigned char filter[3 * 3], unsigned char output_image[480 * 640])
{
    int i;
    int j;
    int c;
    ...
    normal_factor = 0;
    VITIS_LOOP_41_1: for (r = 0; r < 3; r++)
    {
        VITIS_LOOP_43_2: for (c = 0; c < 3; c++)
        {
    ...
    VITIS_LOOP_52_3: for (r = 0; r < 480 - 3 + 1; r++)
    {
        VITIS_LOOP_54_4: for (c = 0; c < 640 - 3 + 1; c++)
        {
            sum = 0;
            VITIS_LOOP_57_5: for (i = 0; i < 3; i++)
            {
                VITIS_LOOP_59_6: for (j = 0; j < 3; j++)
                {
...
void convolve2d_vertical(unsigned char input_image[480 * 640], unsigned char filter[3 * 3], unsigned char output_image[480 * 640])
{
    int i;
    int j;
    int c;
...
void convolve2d_horizontal(unsigned char input_image[480 * 640], unsigned char filter[3 * 3], unsigned char output_image[480 * 640])
{
    int i;
    int j;
    int c;
...
#pragma HLS pipeline
 temp1 = abs(image_gray[i * 640 + j]);
            ...
            output[i * 640 + j] = (temp3 > 150) ? 255 : 0;
        }
    }
}

void set_smoothing_filter(unsigned char filter[3 * 3])
{
    filter[0] = 1;
    filter[1] = 2;
    filter[2] = 1;
...
void set_vertical_filter(unsigned char filter[3 * 3])
{
    filter[0] = -1;
    filter[1] = 0;
    filter[2] = 1;
...
void set_horizontal_filter(unsigned char filter[3 * 3])
{
    filter[0] = 1;
    filter[1] = 2;
    filter[2] = 1;
...
__attribute__((sdx_kernel("edgedetect", 0))) void edgedetect(unsigned char image_rgb[480 * 640 * 3],
                 unsigned char image_gray[480 * 640],
                 unsigned char temp_buf[480 * 640],
                 unsigned char filter[3 * 3],
