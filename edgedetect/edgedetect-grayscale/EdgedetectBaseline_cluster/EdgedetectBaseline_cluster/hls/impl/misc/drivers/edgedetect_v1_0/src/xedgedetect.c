...
void XEdgedetect_Set_input_image(XEdgedetect *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XEdgedetect_WriteReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_INPUT_IMAGE_DATA, (u32)(Data));
    XEdgedetect_WriteReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_INPUT_IMAGE_DATA + 4, (u32)(Data >> 32));
}

u64 XEdgedetect_Get_input_image(XEdgedetect *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XEdgedetect_ReadReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_INPUT_IMAGE_DATA);
    Data += (u64)XEdgedetect_ReadReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_INPUT_IMAGE_DATA + 4) << 32;
    return Data;
}

void XEdgedetect_Set_output_image(XEdgedetect *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XEdgedetect_WriteReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_OUTPUT_IMAGE_DATA, (u32)(Data));
    XEdgedetect_WriteReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_OUTPUT_IMAGE_DATA + 4, (u32)(Data >> 32));
}

u64 XEdgedetect_Get_output_image(XEdgedetect *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XEdgedetect_ReadReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_OUTPUT_IMAGE_DATA);
    Data += (u64)XEdgedetect_ReadReg(InstancePtr->Control_BaseAddress, XEDGEDETECT_CONTROL_ADDR_OUTPUT_IMAGE_DATA + 4) << 32;
    return Data;
}
