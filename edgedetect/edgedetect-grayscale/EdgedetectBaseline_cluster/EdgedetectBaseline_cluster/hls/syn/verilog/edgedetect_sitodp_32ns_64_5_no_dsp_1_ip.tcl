...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name edgedetect_sitodp_32ns_64_5_no_dsp_1_ip
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Custom \
                          ...
                          CONFIG.component_name edgedetect_sitodp_32ns_64_5_no_dsp_1_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips edgedetect_sitodp_32ns_64_5_no_dsp_1_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files edgedetect_sitodp_32ns_64_5_no_dsp_1_ip.xci]
generate_target {synthesis simulation} [get_files edgedetect_sitodp_32ns_64_5_no_dsp_1_ip.xci]
