...
extern "C" void apatb_edgedetect_hw(volatile void * __xlx_apatb_param_image_rgb, volatile void * __xlx_apatb_param_output_r) {
...
((Byte<64>*)__xlx_apatb_param_image_rgb)[i] = __xlx_image_rgb_output_r__tmp_vec[__xlx_offset_param_image_rgb+i];
}
// print __xlx_apatb_param_output_r
for (size_t i = 0; i < __xlx_size_param_output_r; ++i) {
((Byte<64>*)__xlx_apatb_param_output_r)[i] = __xlx_image_rgb_output_r__tmp_vec[__xlx_offset_param_output_r+i];
}
}
