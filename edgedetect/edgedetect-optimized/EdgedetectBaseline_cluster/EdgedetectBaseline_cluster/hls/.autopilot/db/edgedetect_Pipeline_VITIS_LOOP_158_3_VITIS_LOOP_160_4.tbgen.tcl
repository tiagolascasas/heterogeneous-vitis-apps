set moduleName edgedetect_Pipeline_VITIS_LOOP_158_3_VITIS_LOOP_160_4
set isTopModule 0
...
set C_modelName {edgedetect_Pipeline_VITIS_LOOP_158_3_VITIS_LOOP_160_4}
...
set C_modelArgList {
	...
	{ normal_factor_8_reload int 5 regular  }
	{ icmp_ln155 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "image_rgb","offset": { "type": "dynamic","port_name": "image_rgb","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "normal_factor_8_reload", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln155", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ normal_factor_8_reload sc_in sc_lv 5 signal 2 } 
	{ icmp_ln155 sc_in sc_lv 1 signal 3 } 
	{ temp_buf_address0 sc_out sc_lv 19 signal 4 } 
	{ temp_buf_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp_buf_we0 sc_out sc_logic 1 signal 4 } 
	{ temp_buf_d0 sc_out sc_lv 8 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "normal_factor_8_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "normal_factor_8_reload", "role": "default" }} , 
 	{ "name": "icmp_ln155", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln155", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_11s_6ns_8_15_1_U94", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1829873", "Max" : "1829873"}
	, {"Name" : "Interval", "Min" : "1829873", "Max" : "1829873"}
]}
...
set Spec2ImplPortList { 
	...
	normal_factor_8_reload { ap_none {  { normal_factor_8_reload in_data 0 5 } } }
	icmp_ln155 { ap_none {  { icmp_ln155 in_data 0 1 } } }
