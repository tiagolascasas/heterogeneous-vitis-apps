...
void convolve2d_smoothing(unsigned char *input_image, unsigned char *output_image)
{
    ...
    normal_factor = 0;
    VITIS_LOOP_47_1: for (r = 0; r < 3; r++)
    {
        VITIS_LOOP_49_2: for (c = 0; c < 3; c++)
        {
    ...
    VITIS_LOOP_58_3: for (r = 0; r < 480 - 3 + 1; r++)
    {
        VITIS_LOOP_60_4: for (c = 0; c < 640 - 3 + 1; c++)
        {
            sum = 0;
            VITIS_LOOP_63_5: for (i = 0; i < 3; i++)
            {
                VITIS_LOOP_65_6: for (j = 0; j < 3; j++)
                {
...
void convolve2d_vertical(unsigned char *input_image, unsigned char *output_image)
{
    ...
    normal_factor = 0;
    VITIS_LOOP_97_1: for (r = 0; r < 3; r++)
    {
        VITIS_LOOP_99_2: for (c = 0; c < 3; c++)
        {
            normal_factor += abs(filter[r * 3 + c]);
        }
    }
    ...
    VITIS_LOOP_108_3: for (r = 0; r < 480 - 3 + 1; r++)
    {
        VITIS_LOOP_110_4: for (c = 0; c < 640 - 3 + 1; c++)
        {
            sum = 0;
            VITIS_LOOP_113_5: for (i = 0; i < 3; i++)
            {
                VITIS_LOOP_115_6: for (j = 0; j < 3; j++)
                {
                    sum += input_image[(r + i) * 640 + (c + j)] * filter[i * 3 + j];
                }
            }
...
void convolve2d_horizontal(unsigned char *input_image, unsigned char *output_image)
{
    ...
    normal_factor = 0;
    VITIS_LOOP_147_1: for (r = 0; r < 3; r++)
    {
        VITIS_LOOP_149_2: for (c = 0; c < 3; c++)
        {
            normal_factor += abs(filter[r * 3 + c]);
        }
    }
    ...
    VITIS_LOOP_158_3: for (r = 0; r < 480 - 3 + 1; r++)
    {
        VITIS_LOOP_160_4: for (c = 0; c < 640 - 3 + 1; c++)
        {
            sum = 0;
            VITIS_LOOP_163_5: for (i = 0; i < 3; i++)
            {
                VITIS_LOOP_165_6: for (j = 0; j < 3; j++)
                {
                    sum += input_image[(r + i) * 640 + (c + j)] * filter[i * 3 + j];
                }
            }
...
void combthreshold(unsigned char *image_gray, unsigned char *temp_buf, unsigned char *output)
{
    ...
    VITIS_LOOP_183_1: for (i = 0; i < 480; i++)
    {
        VITIS_LOOP_185_2: for (j = 0; j < 640; ++j)
        {
#pragma HLS pipeline
