set moduleName edgedetect_Pipeline_VITIS_LOOP_108_3_VITIS_LOOP_110_4
set isTopModule 0
...
set C_modelName {edgedetect_Pipeline_VITIS_LOOP_108_3_VITIS_LOOP_110_4}
...
set C_modelArgList {
	...
	{ normal_factor_5_reload int 5 regular  }
	{ icmp_ln105 int 1 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "image_rgb","offset": { "type": "dynamic","port_name": "image_rgb","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	...
 	{ "Name" : "normal_factor_5_reload", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln105", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ output_r sc_in sc_lv 64 signal 7 } 
	{ normal_factor_5_reload sc_in sc_lv 5 signal 8 } 
	{ icmp_ln105 sc_in sc_lv 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "normal_factor_5_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "normal_factor_5_reload", "role": "default" }} , 
 	{ "name": "icmp_ln105", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln105", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_19ns_21ns_39_1_1_U78", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_19ns_4ns_3_23_1_U79", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_11s_6ns_8_15_1_U80", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1524908", "Max" : "1524908"}
	, {"Name" : "Interval", "Min" : "1524908", "Max" : "1524908"}
]}
...
set Spec2ImplPortList { 
	...
	normal_factor_5_reload { ap_none {  { normal_factor_5_reload in_data 0 5 } } }
	icmp_ln105 { ap_none {  { icmp_ln105 in_data 0 1 } } }
}
