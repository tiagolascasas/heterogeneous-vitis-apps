...
extern "C"
void apatb_edgedetect_hw(void* __xlx_apatb_param_image_rgb, void* __xlx_apatb_param_output_r)
{
  ...
  try {
    ...
    edgedetect_hw_stub_wrapper(__xlx_apatb_param_image_rgb, __xlx_apatb_param_output_r);
