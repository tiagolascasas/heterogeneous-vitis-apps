...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename temp_buf \
    op interface \
    ports { temp_buf_address0 { O 19 vector } temp_buf_ce0 { O 1 bit } temp_buf_we0 { O 1 bit } temp_buf_d0 { O 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { normal_factor_8_reload { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln155 \
    op interface \
    ports { icmp_ln155 { I 1 vector } } \
} "
}
