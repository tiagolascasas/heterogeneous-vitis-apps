...
set C_modelArgList {
	{ gmem int 8 unused {axi_master 0}  }
	{ image_rgb int 64 unused {axi_slave 0}  }
	{ image_gray int 64 unused {axi_slave 0}  }
	{ temp_buf int 64 unused {axi_slave 0}  }
	{ filter int 64 unused {axi_slave 0}  }
	{ output_r int 64 unused {axi_slave 0}  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "image_rgb","offset": { "type": "dynamic","port_name": "image_rgb","bundle": "control"}},{"cName": "image_gray","offset": { "type": "dynamic","port_name": "image_gray","bundle": "control"}},{"cName": "temp_buf","offset": { "type": "dynamic","port_name": "temp_buf","bundle": "control"}},{"cName": "filter","offset": { "type": "dynamic","port_name": "filter","bundle": "control"}},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"}}]}]} , 
...
set ArgLastReadFirstWriteLatency {
	edgedetect {
		...
		image_rgb {Type I LastRead -1 FirstWrite -1}
		image_gray {Type I LastRead -1 FirstWrite -1}
		temp_buf {Type I LastRead -1 FirstWrite -1}
