...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_cluster_1_0"]
set install_ip_cache "/tools/Xilinx/Vitis/2024.2/data/cache/xilinx"
...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/tools/Xilinx/Vitis/2024.2/base_platforms/xilinx_zcu102_base_202420_1/hw_emu/hw_emu.xsa" \
  hw_platform_part             "xczu9eg-ffvb1156-2-e" \
  hw_platform_vbnv             "xilinx.com:xd:xilinx_zcu102_base_202420_1:202420.1" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  emu_user_ip_repo             "" \
  emu_src_dir                  "" \
  emu_pfm_metadata_version     "2024.2" \
  ...
  xpfm_file                    "/tools/Xilinx/Vitis/2024.2/base_platforms/xilinx_zcu102_base_202420_1/xilinx_zcu102_base_202420_1.xpfm" \
...
set config_info [dict create \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/tls/dev/heterogeneous-vitis-apps/apps/vadd/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
...
set data_profile_cluster_1_M_AXI_GMEM0 [dict create \
  port cluster_1/M_AXI_GMEM0 \
  option all \
];
set data_profile_cluster_1_M_AXI_GMEM1 [dict create \
  port cluster_1/M_AXI_GMEM1 \
  option all \
];
set stall_profile_cluster_1 [dict create \
  port cluster_1 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  AIE [list] \
  DATA [list $data_profile_cluster_1_M_AXI_GMEM0 $data_profile_cluster_1_M_AXI_GMEM1] \
  STALL [list $stall_profile_cluster_1] \
  EXEC [list] \
  MEMORY [list ] \
