...
module cluster_read_input_Pipeline_mem_rd (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [30:0] i_fu_52;
wire   [30:0] add_ln69_fu_102_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [31:0] zext_ln69_fu_92_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln69_fu_96_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln69_fu_96_p2 == 1'd0))) begin
...
assign add_ln69_fu_102_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
assign icmp_ln69_fu_96_p2 = (($signed(zext_ln69_fu_92_p1) < $signed(size)) ? 1'b1 : 1'b0);
...
assign zext_ln69_fu_92_p1 = ap_sig_allocacmp_i_load;

endmodule //cluster_read_input_Pipeline_mem_rd
