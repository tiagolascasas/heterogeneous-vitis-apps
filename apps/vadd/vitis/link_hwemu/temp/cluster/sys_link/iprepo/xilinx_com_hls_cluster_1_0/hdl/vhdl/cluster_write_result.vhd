...
entity cluster_write_result is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cluster_write_result is 
...
attribute shreg_extract : string;
    ...
    signal size_1_reg_137 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln94_1_reg_142 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWVALID : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WVALID : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WLAST : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARVALID : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_RREADY : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_BREADY : STD_LOGIC;
    signal grp_write_result_Pipeline_mem_wr_fu_73_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal sext_ln94_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln94_fu_121_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln94_fu_83_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln94_fu_89_p1 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    component cluster_write_result_Pipeline_mem_wr IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        m_axi_gmem0_0_BID : IN STD_LOGIC_VECTOR (0 downto 0);
        m_axi_gmem0_0_BUSER : IN STD_LOGIC_VECTOR (0 downto 0);
        size_1 : IN STD_LOGIC_VECTOR (31 downto 0);
...
begin
    grp_write_result_Pipeline_mem_wr_fu_73 : component cluster_write_result_Pipeline_mem_wr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        m_axi_gmem0_0_AWVALID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWVALID,
        m_axi_gmem0_0_AWREADY => m_axi_gmem0_0_AWREADY,
        m_axi_gmem0_0_AWADDR => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWADDR,
        m_axi_gmem0_0_AWID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWID,
        m_axi_gmem0_0_AWLEN => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN,
        m_axi_gmem0_0_AWSIZE => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWSIZE,
        m_axi_gmem0_0_AWBURST => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWBURST,
        m_axi_gmem0_0_AWLOCK => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLOCK,
        m_axi_gmem0_0_AWCACHE => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWCACHE,
        m_axi_gmem0_0_AWPROT => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWPROT,
        m_axi_gmem0_0_AWQOS => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWQOS,
        m_axi_gmem0_0_AWREGION => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWREGION,
        m_axi_gmem0_0_AWUSER => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWUSER,
        m_axi_gmem0_0_WVALID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WVALID,
        m_axi_gmem0_0_WREADY => m_axi_gmem0_0_WREADY,
        m_axi_gmem0_0_WDATA => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WDATA,
        m_axi_gmem0_0_WSTRB => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WSTRB,
        m_axi_gmem0_0_WLAST => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WLAST,
        m_axi_gmem0_0_WID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WID,
        m_axi_gmem0_0_WUSER => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WUSER,
        m_axi_gmem0_0_ARVALID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARVALID,
        m_axi_gmem0_0_ARREADY => ap_const_logic_0,
        m_axi_gmem0_0_ARADDR => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARADDR,
        m_axi_gmem0_0_ARID => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARID,
        m_axi_gmem0_0_ARLEN => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARLEN,
        m_axi_gmem0_0_ARSIZE => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARSIZE,
        m_axi_gmem0_0_ARBURST => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARBURST,
        m_axi_gmem0_0_ARLOCK => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARLOCK,
        m_axi_gmem0_0_ARCACHE => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARCACHE,
        m_axi_gmem0_0_ARPROT => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARPROT,
        m_axi_gmem0_0_ARQOS => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARQOS,
        m_axi_gmem0_0_ARREGION => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARREGION,
        m_axi_gmem0_0_ARUSER => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_ARUSER,
        m_axi_gmem0_0_RVALID => ap_const_logic_0,
        m_axi_gmem0_0_RREADY => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_RREADY,
        ...
        m_axi_gmem0_0_BREADY => grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_BREADY,
        m_axi_gmem0_0_BRESP => m_axi_gmem0_0_BRESP,
        m_axi_gmem0_0_BID => m_axi_gmem0_0_BID,
        m_axi_gmem0_0_BUSER => m_axi_gmem0_0_BUSER,
        size_1 => size_1_reg_137,
        sext_ln94 => trunc_ln94_1_reg_142);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                empty_reg_148 <= empty_fu_103_p3;
                size_1_reg_137 <= size_dout;
                trunc_ln94_1_reg_142 <= out_r_dout(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_0_AWREADY, m_axi_gmem0_0_BVALID, ap_CS_fsm_state2, ap_CS_fsm_state72, ap_block_state1, grp_write_result_Pipeline_mem_wr_fu_73_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_state72 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state72;
                end if;
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(m_axi_gmem0_0_AWREADY)
    begin
    ...
    ap_ST_fsm_state72_blk_assign_proc : process(m_axi_gmem0_0_BVALID)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem0_0_BVALID, ap_CS_fsm_state72)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem0_0_BVALID, ap_CS_fsm_state72)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then 
    ...
    empty_fu_103_p3 <= 
        trunc_ln94_fu_89_p1 when (icmp_ln94_fu_83_p2(0) = '1') else 
        ap_const_lv31_0;

    gmem0_blk_n_AW_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2)
    begin
    ...
    gmem0_blk_n_B_assign_proc : process(m_axi_gmem0_0_BVALID, ap_CS_fsm_state72)
    begin
    ...
    icmp_ln94_fu_83_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    m_axi_gmem0_0_AWADDR_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln94_fu_111_p1)
    begin
        if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_0_AWADDR <= sext_ln94_fu_111_p1;
    ...
    m_axi_gmem0_0_AWBURST_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWBURST, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
    ...
    m_axi_gmem0_0_AWCACHE_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWCACHE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWCACHE <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWCACHE;
        else 
    ...
    m_axi_gmem0_0_AWID_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWID <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWID;
        else 
    ...
    m_axi_gmem0_0_AWLEN_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln94_fu_121_p1)
    begin
        if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_0_AWLEN <= zext_ln94_fu_121_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWLEN <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN;
        else 
    ...
    m_axi_gmem0_0_AWLOCK_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLOCK, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWLOCK <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLOCK;
        else 
    ...
    m_axi_gmem0_0_AWPROT_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWPROT, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWPROT <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWPROT;
        else 
    ...
    m_axi_gmem0_0_AWQOS_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWQOS, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWQOS <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWQOS;
        else 
    ...
    m_axi_gmem0_0_AWREGION_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWREGION, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWREGION <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWREGION;
        else 
    ...
    m_axi_gmem0_0_AWSIZE_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWSIZE, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWSIZE <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWSIZE;
        else 
    ...
    m_axi_gmem0_0_AWUSER_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWUSER, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWUSER <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWUSER;
        else 
    ...
    m_axi_gmem0_0_AWVALID_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    m_axi_gmem0_0_BREADY_assign_proc : process(m_axi_gmem0_0_BVALID, ap_CS_fsm_state72, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_BREADY, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_0_WVALID_assign_proc : process(grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WVALID, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_WVALID <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_WVALID;
        else 
    ...
    begin
        ...
        sext_ln94_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln94_1_reg_142),64));
    ...
    trunc_ln94_fu_89_p1 <= size_dout(31 - 1 downto 0);
    zext_ln94_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_148),64));
end behav;
