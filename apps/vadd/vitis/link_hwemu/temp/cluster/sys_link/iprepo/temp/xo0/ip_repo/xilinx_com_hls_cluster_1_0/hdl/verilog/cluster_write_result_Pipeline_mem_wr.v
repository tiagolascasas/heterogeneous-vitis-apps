...
module cluster_write_result_Pipeline_mem_wr (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [30:0] i_fu_54;
wire   [30:0] add_ln94_fu_106_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
wire    ap_block_pp0_stage0;
wire   [31:0] zext_ln94_fu_96_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln94_fu_100_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln94_fu_100_p2 == 1'd0))) begin
...
assign add_ln94_fu_106_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = ((outStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_gmem0_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((outStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((m_axi_gmem0_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((outStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_gmem0_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((outStream_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign icmp_ln94_fu_100_p2 = (($signed(zext_ln94_fu_96_p1) < $signed(size_1)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_0_WDATA = outStream_read_reg_139;
...
assign zext_ln94_fu_96_p1 = ap_sig_allocacmp_i_load;

endmodule //cluster_write_result_Pipeline_mem_wr
