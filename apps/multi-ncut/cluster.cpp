...
void cluster(int input_width, int input_height, float *input_data, int dim,
             int *rtr_val_width, int *rtr_val_height, int *rtr_val_data) {

#pragma HLS INTERFACE m_axi port = input_data bundle = gmem0
#pragma HLS INTERFACE m_axi port = rtr_val_width bundle = gmem1
#pragma HLS INTERFACE m_axi port = rtr_val_height bundle = gmem2
#pragma HLS INTERFACE m_axi port = rtr_val_data bundle = gmem3
...
#pragma HLS loop_tripcount max = 92006
      out_i44_data[i_i38 * out_i44_width + j_i38] =
          input_data[i_i38 * input_width + j_i38];
    }
  }
