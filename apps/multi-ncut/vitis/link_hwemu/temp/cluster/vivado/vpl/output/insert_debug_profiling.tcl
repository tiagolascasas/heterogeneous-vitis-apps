...
set dpa_dict [list \
              [get_bd_intf_pins cluster_1/m_axi_gmem]  {TYPE data DETAIL all CLK_SRC /cluster_1/ap_clk RST_SRC /cluster_1/ap_rst_n MIN_ADDRESS {0xC0000000 0x0} MAX_ADDRESS {0xFFFFFFFFF 0x7FFFFFFF} MEMORY {HP HP0} PRINTABLE_KEY {[get_bd_intf_pins cluster_1/m_axi_gmem]} INS_MODE auto} \
             ]
set dpa_opts [list \
...
set_param bd.debug_profile.script /home/tls/dev/heterogeneous-vitis-apps/apps/multi-ncut/vitis/link_hwemu/temp/cluster/vivado/vpl/.local/debug_profile_automation.tcl
apply_bd_automation -rule xilinx.com:bd_rule:debug_profile -opts $dpa_opts -dict $dpa_dict

# Write debug_ip_layout
debug_profile::write_debug_ip_layout true "xilinx.com:xd:xilinx_zcu102_base_202420_1:202420.1" "/home/tls/dev/heterogeneous-vitis-apps/apps/multi-ncut/vitis/link_hwemu/temp/cluster/int"
