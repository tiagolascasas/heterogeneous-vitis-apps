...
set C_modelArgMapList {[ 
	{ "Name" : "size_2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outStream_num_data_valid sc_in sc_lv 32 signal 3 } 
	{ outStream_fifo_cap sc_in sc_lv 32 signal 3 } 
	{ size_2 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outStream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outStream", "role": "num_data_valid" }} , 
 	{ "name": "outStream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outStream", "role": "fifo_cap" }} , 
 	{ "name": "size_2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "size_2", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "size_2", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	compute_add_Pipeline_execute {
		size_2 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	size_2 { ap_none {  { size_2 in_data 0 32 } } }
	inStream1 { ap_fifo {  { inStream1_dout fifo_data_in 0 32 }  { inStream1_empty_n fifo_status 0 1 }  { inStream1_read fifo_port_we 1 1 }  { inStream1_num_data_valid fifo_status_num_data_valid 0 3 }  { inStream1_fifo_cap fifo_update 0 3 } } }
	inStream2 { ap_fifo {  { inStream2_dout fifo_data_in 0 32 }  { inStream2_empty_n fifo_status 0 1 }  { inStream2_read fifo_port_we 1 1 }  { inStream2_num_data_valid fifo_status_num_data_valid 0 3 }  { inStream2_fifo_cap fifo_update 0 3 } } }
	outStream { ap_fifo {  { outStream_din fifo_data_in 1 32 }  { outStream_full_n fifo_status 0 1 }  { outStream_write fifo_port_we 1 1 }  { outStream_num_data_valid fifo_status_num_data_valid 0 32 }  { outStream_fifo_cap fifo_update 0 32 } } }
}
