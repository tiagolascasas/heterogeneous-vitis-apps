...
set Spec2ImplPortList { 
	...
	size_c1 { ap_fifo {  { size_c1_din fifo_data_in 1 32 }  { size_c1_full_n fifo_status 0 1 }  { size_c1_write fifo_port_we 1 1 }  { size_c1_num_data_valid fifo_status_num_data_valid 0 3 }  { size_c1_fifo_cap fifo_update 0 3 } } }
	inStream1 { ap_fifo {  { inStream1_din fifo_data_in 1 32 }  { inStream1_full_n fifo_status 0 1 }  { inStream1_write fifo_port_we 1 1 }  { inStream1_num_data_valid fifo_status_num_data_valid 0 3 }  { inStream1_fifo_cap fifo_update 0 3 } } }
}
