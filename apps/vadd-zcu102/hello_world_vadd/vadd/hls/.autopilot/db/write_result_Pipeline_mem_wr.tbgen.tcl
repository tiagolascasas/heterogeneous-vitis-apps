...
set C_modelArgMapList {[ 
	{ "Name" : "size_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ size_1 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "size_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "size_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "size_1", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	write_result_Pipeline_mem_wr {
		size_1 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	size_1 { ap_none {  { size_1 in_data 0 32 } } }
	...
	outStream { ap_fifo {  { outStream_dout fifo_data_in 0 32 }  { outStream_empty_n fifo_status 0 1 }  { outStream_read fifo_port_we 1 1 }  { outStream_num_data_valid fifo_status_num_data_valid 0 3 }  { outStream_fifo_cap fifo_update 0 3 } } }
}
