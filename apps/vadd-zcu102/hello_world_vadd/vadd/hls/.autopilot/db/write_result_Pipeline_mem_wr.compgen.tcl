...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outStream_dout { I 32 vector } outStream_empty_n { I 1 bit } outStream_read { O 1 bit } outStream_num_data_valid { I 3 vector } outStream_fifo_cap { I 3 vector } } \
} "
}
