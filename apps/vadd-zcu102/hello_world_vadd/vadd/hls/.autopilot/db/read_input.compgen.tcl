...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_size_c1 \
    op interface \
    ports { size_c1_din { O 32 vector } size_c1_full_n { I 1 bit } size_c1_write { O 1 bit } size_c1_num_data_valid { I 3 vector } size_c1_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inStream1_din { O 32 vector } inStream1_full_n { I 1 bit } inStream1_write { O 1 bit } inStream1_num_data_valid { I 3 vector } inStream1_fifo_cap { I 3 vector } } \
} "
}
