...
attribute shreg_extract : string;
    ...
    signal trunc_ln89_1_reg_142 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    port map (
        ...
        sext_ln89 => trunc_ln89_1_reg_142,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                ...
                trunc_ln89_1_reg_142 <= out_r_dout(63 downto 2);
            end if;
        end if;
    end process;
    ...
    m_axi_gmem0_0_AWADDR_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWADDR, ap_CS_fsm_state3, ap_CS_fsm_state4, sext_ln89_fu_111_p1)
    begin
        if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_0_AWADDR <= sext_ln89_fu_111_p1;
    ...
    m_axi_gmem0_0_AWLEN_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2, grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN, ap_CS_fsm_state3, ap_CS_fsm_state4, zext_ln89_fu_121_p1)
    begin
        if (((m_axi_gmem0_0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_0_AWLEN <= zext_ln89_fu_121_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_0_AWLEN <= grp_write_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_0_AWLEN;
        else 
    ...
    begin
        ...
        sext_ln89_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln89_1_reg_142),64));
    ...
    zext_ln89_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_148),64));
end behav;
