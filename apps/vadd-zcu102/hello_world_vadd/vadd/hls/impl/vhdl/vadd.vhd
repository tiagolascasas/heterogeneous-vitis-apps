...
architecture behav of vadd is 
    ...
    "vadd_vadd,hls_ip_2024_2_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.866910,HLS_SYN_LAT=4243,HLS_SYN_TPT=4173,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=3364,HLS_SYN_LUT=4404,HLS_VERSION=2024_2_2}";
