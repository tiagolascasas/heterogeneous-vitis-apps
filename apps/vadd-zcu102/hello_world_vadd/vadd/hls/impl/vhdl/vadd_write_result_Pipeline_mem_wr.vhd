...
begin
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln89_fu_100_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln89_fu_100_p2 <= "1" when (signed(zext_ln89_fu_96_p1) < signed(size_1)) else "0";
