...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln89_fu_100_p2 == 1'd0))) begin
...
assign icmp_ln89_fu_100_p2 = (($signed(zext_ln89_fu_96_p1) < $signed(size_1)) ? 1'b1 : 1'b0);
