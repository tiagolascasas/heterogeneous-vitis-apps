...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((outStream_full_n == 1'b0) | (inStream2_empty_n == 1'b0) | (inStream1_empty_n == 1'b0));
end
...
assign icmp_ln80_fu_81_p2 = (($signed(zext_ln77_fu_77_p1) < $signed(size_2)) ? 1'b1 : 1'b0);

assign outStream_din = (inStream2_dout + inStream1_dout);

assign zext_ln77_fu_77_p1 = ap_sig_allocacmp_i_load;
