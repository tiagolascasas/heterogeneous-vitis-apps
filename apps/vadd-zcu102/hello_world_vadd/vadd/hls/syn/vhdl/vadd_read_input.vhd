...
attribute shreg_extract : string;
    ...
    signal trunc_ln68_2_reg_155 : STD_LOGIC_VECTOR (61 downto 0);
...
begin
    ...
    port map (
        ...
        sext_ln68 => trunc_ln68_2_reg_155,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_0_ARREADY = ap_const_logic_1))) then
                trunc_ln68_2_reg_155 <= in_r(63 downto 2);
            end if;
        end if;
    end process;
    ...
    m_axi_gmem0_0_ARADDR_assign_proc : process(m_axi_gmem0_0_ARREADY, ap_CS_fsm_state2, grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_0_ARADDR, ap_CS_fsm_state73, ap_CS_fsm_state74, sext_ln68_fu_120_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_0_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem0_0_ARADDR <= sext_ln68_fu_120_p1;
    ...
    m_axi_gmem0_0_ARLEN_assign_proc : process(m_axi_gmem0_0_ARREADY, ap_CS_fsm_state2, zext_ln68_fu_131_p1, grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_0_ARLEN, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_0_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem0_0_ARLEN <= zext_ln68_fu_131_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_0_ARLEN <= grp_read_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_0_ARLEN;
        else 
    ...
    zext_ln68_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_150),64));
end behav;
