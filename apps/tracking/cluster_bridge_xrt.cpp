                                        ...
                                        F2D **np_temp, int *k, int *numFind, int *i)
{
    ...
    bo_WINSZ.read(&WINSZ_val);
    bo_accuracy.read(&accuracy_val);
    bo_LK_ITER.read(&LK_ITER_val);
    bo_k.read(&k_val);
    bo_numFind.read(&numFind_val);
    bo_i.read(&i_val);
