set moduleName cluster_Pipeline_VITIS_LOOP_112_5
set isTopModule 0
...
set C_modelName {cluster_Pipeline_VITIS_LOOP_112_5}
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "phi_mul", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ SAD_w sc_in sc_lv 32 signal 2 } 
	{ phi_mul sc_in sc_lv 62 signal 3 } 
	{ integralImg_data sc_in sc_lv 64 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "phi_mul", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "phi_mul", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "88657", "Max" : "88657"}
	, {"Name" : "Interval", "Min" : "88657", "Max" : "88657"}
]}
...
set Spec2ImplPortList { 
	...
	phi_mul { ap_none {  { phi_mul in_data 0 62 } } }
