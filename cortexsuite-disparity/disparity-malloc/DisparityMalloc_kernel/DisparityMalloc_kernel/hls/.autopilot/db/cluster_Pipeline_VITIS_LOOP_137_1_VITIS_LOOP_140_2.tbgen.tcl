set moduleName cluster_Pipeline_VITIS_LOOP_137_1_VITIS_LOOP_140_2
set isTopModule 0
...
set C_modelName {cluster_Pipeline_VITIS_LOOP_137_1_VITIS_LOOP_140_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 64 regular {axi_master 2}  }
	{ sub2_i int 32 regular  }
	{ bound149 int 64 regular  }
	{ sext_ln137_1 int 32 regular  }
	{ integralImg_w_cast int 32 regular  }
	{ integralImg_data int 64 regular  }
	{ sext_ln137 int 32 regular  }
	{ retSAD_data int 64 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "Ileft_data","offset": { "type": "dynamic","port_name": "Ileft_data","bundle": "control"},"direction": "READONLY"},{"cName": "Iright_data","offset": { "type": "dynamic","port_name": "Iright_data","bundle": "control"},"direction": "READONLY"},{"cName": "Iright_moved_data","offset": { "type": "dynamic","port_name": "Iright_moved_data","bundle": "control"},"direction": "READWRITE"},{"cName": "SAD_data","offset": { "type": "dynamic","port_name": "SAD_data","bundle": "control"},"direction": "READWRITE"},{"cName": "integralImg_data","offset": { "type": "dynamic","port_name": "integralImg_data","bundle": "control"},"direction": "READWRITE"},{"cName": "retSAD_data","offset": { "type": "dynamic","port_name": "retSAD_data","bundle": "control"},"direction": "WRITEONLY"},{"cName": "range_data","offset": { "type": "dynamic","port_name": "range_data","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sub2_i", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "bound149", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln137_1", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "retSAD_data", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sub2_i sc_in sc_lv 32 signal 1 } 
	{ bound149 sc_in sc_lv 64 signal 2 } 
	{ sext_ln137_1 sc_in sc_lv 32 signal 3 } 
	{ integralImg_w_cast sc_in sc_lv 32 signal 4 } 
	{ integralImg_data sc_in sc_lv 64 signal 5 } 
	{ sext_ln137 sc_in sc_lv 32 signal 6 } 
	{ retSAD_data sc_in sc_lv 64 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub2_i", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub2_i", "role": "default" }} , 
 	{ "name": "bound149", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "bound149", "role": "default" }} , 
 	{ "name": "sext_ln137_1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sext_ln137_1", "role": "default" }} , 
 	...
 	{ "name": "retSAD_data", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "retSAD_data", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_32s_62_1_1_U53", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_33s_32s_62_1_1_U54", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1127204", "Max" : "1127204"}
	, {"Name" : "Interval", "Min" : "1127204", "Max" : "1127204"}
]}
...
set Spec2ImplPortList { 
	...
	sub2_i { ap_none {  { sub2_i in_data 0 32 } } }
	bound149 { ap_none {  { bound149 in_data 0 64 } } }
	sext_ln137_1 { ap_none {  { sext_ln137_1 in_data 0 32 } } }
	...
	retSAD_data { ap_none {  { retSAD_data in_data 0 64 } } }
}
