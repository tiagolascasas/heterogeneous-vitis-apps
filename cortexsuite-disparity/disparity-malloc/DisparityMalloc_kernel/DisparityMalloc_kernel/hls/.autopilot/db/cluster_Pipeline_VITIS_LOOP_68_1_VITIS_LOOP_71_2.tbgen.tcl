set moduleName cluster_Pipeline_VITIS_LOOP_68_1_VITIS_LOOP_71_2
set isTopModule 0
...
set C_modelName {cluster_Pipeline_VITIS_LOOP_68_1_VITIS_LOOP_71_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem int 64 regular {axi_master 2}  }
	{ Ileft_w int 32 regular  }
	{ mul_ln41 int 64 regular  }
	{ SAD_w_cast34 int 32 regular  }
	{ Iright_moved_w_cast int 32 regular  }
	{ Ileft_w_cast int 32 regular  }
	{ Ileft_data int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "Ileft_data","offset": { "type": "dynamic","port_name": "Ileft_data","bundle": "control"},"direction": "READONLY"},{"cName": "Iright_data","offset": { "type": "dynamic","port_name": "Iright_data","bundle": "control"},"direction": "READONLY"},{"cName": "Iright_moved_data","offset": { "type": "dynamic","port_name": "Iright_moved_data","bundle": "control"},"direction": "READWRITE"},{"cName": "SAD_data","offset": { "type": "dynamic","port_name": "SAD_data","bundle": "control"},"direction": "READWRITE"},{"cName": "integralImg_data","offset": { "type": "dynamic","port_name": "integralImg_data","bundle": "control"},"direction": "READWRITE"},{"cName": "retSAD_data","offset": { "type": "dynamic","port_name": "retSAD_data","bundle": "control"},"direction": "WRITEONLY"},{"cName": "range_data","offset": { "type": "dynamic","port_name": "range_data","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "Ileft_w", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln41", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "Ileft_w_cast", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "Ileft_data", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Ileft_w sc_in sc_lv 32 signal 1 } 
	{ mul_ln41 sc_in sc_lv 64 signal 2 } 
	{ SAD_w_cast34 sc_in sc_lv 32 signal 3 } 
	{ Iright_moved_w_cast sc_in sc_lv 32 signal 4 } 
	{ Ileft_w_cast sc_in sc_lv 32 signal 5 } 
	{ Ileft_data sc_in sc_lv 64 signal 6 } 
	{ Iright_moved_data sc_in sc_lv 64 signal 7 } 
	{ SAD_data sc_in sc_lv 64 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Ileft_w", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Ileft_w", "role": "default" }} , 
 	{ "name": "mul_ln41", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "mul_ln41", "role": "default" }} , 
 	...
 	{ "name": "Ileft_w_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Ileft_w_cast", "role": "default" }} , 
 	{ "name": "Ileft_data", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "Ileft_data", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitofp_32ns_32_5_no_dsp_1_U15", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_32s_62_1_1_U16", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_31ns_32s_62_1_1_U17", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U18", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "580871", "Max" : "580871"}
	, {"Name" : "Interval", "Min" : "580871", "Max" : "580871"}
]}
...
set Spec2ImplPortList { 
	...
	Ileft_w { ap_none {  { Ileft_w in_data 0 32 } } }
	mul_ln41 { ap_none {  { mul_ln41 in_data 0 64 } } }
	SAD_w_cast34 { ap_none {  { SAD_w_cast34 in_data 0 32 } } }
	Iright_moved_w_cast { ap_none {  { Iright_moved_w_cast in_data 0 32 } } }
	Ileft_w_cast { ap_none {  { Ileft_w_cast in_data 0 32 } } }
	Ileft_data { ap_none {  { Ileft_data in_data 0 64 } } }
