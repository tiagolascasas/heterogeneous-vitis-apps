...
extern "C"
void vadd_hw_stub_wrapper(hls::sim::Byte<4>);

extern "C"
void apatb_vadd_hw(hls::sim::Byte<4> __xlx_apatb_param_size)
{
  ...
  port0.param = &__xlx_apatb_param_size;
  ...
  try {
    ...
    vadd_hw_stub_wrapper(__xlx_apatb_param_size);
